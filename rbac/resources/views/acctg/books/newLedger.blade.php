        ...
        <form action="{{ route('saveledger') }}" method="post">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-4 border border-dark-subtle py-3">
                    ...
                    <div class="mb-3">
                        <label for="entryamount" class="form-label">Amount:</label>
                        <input type="text" name="entryamount" class="form-control form-control-sm text-end" id="entryamount">
                    </div>
                </div>
            </div>
            <div class="row justify-content-center mt-3">
                <div class="col-sm-4 text-center border-start border-bottom border-end border-dark-subtle py-3">
