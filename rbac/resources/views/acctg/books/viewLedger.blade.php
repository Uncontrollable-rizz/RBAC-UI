...
@section('page-content')
    <div class="container-fluid">
        <!-- It is quality rather than quantity that matters. - Lucius Annaeus Seneca -->
        <div class="row mb-3">
            <div class="col-12 text-white bg-dark p-2">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="mb-2">
                    <strong>Entry Number:</strong> {{ $ledger->id }}
                </div>
                <div class="mb-2">
                    <strong>Entry Details:</strong>
                    <textarea readonly class="form-control" rows="5">{{ $ledger->entry }}</textarea>
                </div>
                <div class="mb-2">
                    <strong>Amount:</strong> PHP <span class="fw-bold">{{ number_format($ledger->amount, 2) }}</span>
                </div>
                <div>
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('ledgers') }}" class="btn btn-dark">Back</a>
            </div>
        </div>
    </div>
@endsection
